from create_tables_departments import create_table_main, create_table_staging, create_schema
from upload_data_departments import upload_to_main, upload_to_staging
import os
import json
...
def lambda_handler(event, context):
    ...
    return {
        "statusCode":200,
        "body":json.dumps("Departments data uploaded to redshift successfully")
    }